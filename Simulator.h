...
class Simulator
{
 ...
 public:
  ...
  void show_stats()
  {
    ...
    double land_ave_wait;
    
    land_ave_wait = ((double)landing_queue->get_total_wait())/((double)landing_queue->get_num_served());
    
    std::cout<<"Average landing wait time is: "<<land_ave_wait<<"."<<std::endl;
    ...
    dep_ave_wait = ((double)departure_queue->get_total_wait())/((double)departure_queue->get_num_served());

    std::cout<<"Average departure wait time: "<<dep_ave_wait<<"."<<std::endl;
